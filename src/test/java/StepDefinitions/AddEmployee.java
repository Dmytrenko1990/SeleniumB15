...
public class AddEmployee extends CommonMethods {
    ...
    public void query_the_information_in_backend() {
        ...
        //in this variable we got all the keys and variables for the employee we searched
        GlobalVariables.tabledata = DBUtility.getListOfMapsFromRset(query);
    }

    @Then("verify the results fromfront end and backend")
    public void verify_the_results_fromfront_end_and_backend() {

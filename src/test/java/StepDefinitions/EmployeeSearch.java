...
public class EmployeeSearch extends CommonMethods {
    ...
    public void user_select_job_title() {
      ...
      /*  WebElement empStatusDd1 = driver.findElement(By.id("empsearch_employee_status"));
        selectByOptions(empStatusDd1,"Active");

        WebElement includeDd1 = driver.findElement(By.id("empsearch_termination"));
        selectByOptions(includeDd1, "Current and Past Employees");*/
    }
}

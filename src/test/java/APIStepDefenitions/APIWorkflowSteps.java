...
public class APIWorkflowSteps {
    ...
    //making the request with usual payload
    ...
    public void a_request_is_prepared_to_create_an_employee_with_dynamic_data(String firstName, String lastName, String middleName,
    ...
    @Given("a request is prerared to update an employee")
    public void a_request_is_prerared_to_update_an_employee() {
    ...
    public void a_put_call_is_made_to_update_an_employee() {
       response = request.put(APIConstants.UPDATE_EMPLOYEE_URI);
    }
